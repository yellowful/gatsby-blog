...
const MeterSlider = ({ fireNumber }) => {
  ...
  return (
    <div className="w-100 bg-light-gray">
      <div
        key="meter-slide-line1"
        className="w-70 w-60-m w-50-l ph3 mw8 mt2 mt4-ns center flex items-center"
      >
        <span
          key="meter-icon-ice"
          className="pr2 f3"
      ...
      <div
        key="meter-slide-line2"
        className="w-70 w-60-m w-50-l ph3 mw8 mv2 mb4-ns center flex items-center justify-between"
      >
        <span
          key="meter-text-profesional"
